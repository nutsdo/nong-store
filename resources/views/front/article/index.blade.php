                    ...
                    <div class="content--withBorder">
                        ...
                        <div class="support-author">
                            ...
                            <button class="button--pay">
                                <i class="iconfont icon-money1"></i><span>|</span>打赏</button>
                        </div>
                        <div class="post-actions">
                            <button title="收藏" class="button button--primary button--toggle button--recommend" data-id="{{ $article->id }}" data-action="popLogin">
                                <span class="iconfont icon-heart"></span>
                                <span class="button-label is-default">收藏</span>
                                <span class="button-label is-active">已收藏</span> | <span class="count">0</span>
                            </button>
                            <button class="button button--primary button--postlike" data-yese="ys-like" data-action="post-like" data-id="440033">
                    ...
                    <div class="fixed-article-nav u-clearfix">
                        <div class="u-floatLeft">
                            ...
                            <button title="收藏" class="button button--primary button--recommend button--chromeless"
                                    data-id="440033" data-action="popLogin">
                                <span class="iconfont icon-heart"></span>
                            </button>
                        </div>
                        <div class="u-floatRight">
                            ...
                            <span class="share-wechat">
                                ...
                                <div class="share-qrcode-image"><img src=""/>
                                    <p>扫码分享到微信</p>
                                </div>
                            </span>
                        </div>
                            ...
                            {!! Form::open([
                                ...
                                <div class="comm-con">
                                    ...
                                    <div class="comm-bottom">
                                        <input type="submit" class="inputSubmit submit" data-action="submitComment" value="发布">
                                        <a rel="nofollow" id="cancel-comment-reply-link" href="" style="display:none;">取消回复</a>
                                    </div>
                                    @else
                                    <div class="comment-empty">
                                        <span class=" u-cursorPointer" data-action="popLogin">
                        ...
                        <div class="commentshow">
                            <ol class="comment-list">
                                ...
                                <li class="comment byuser even thread-even depth-1">
                                    ...
                                    {{--<ol class="children">--}}
                                        {{--<li class="comment byuser comment-author-qidian bypostauthor odd alt depth-2" id="li-comment-186083" itemtype="http://schema.org/Comment" itemscope="" itemprop="comment">--}}
                                            {{--<div id="comment-186083" class="comment-block">--}}
                                                {{--<div class="comment-info">--}}

                                                    {{--<div class="comment-meta">--}}
                                                        {{--<div class="comment-author" itemprop="author">起点学院<span class="iconfont icon-level" title="文章作者"></span><span class="color-noraml">回复</span><a href="#comment-186074">香草紫苏</a></div>--}}
                                                        {{--<span class="comment-reply-link u-cursorPointer"><span class="comment-reply-link u-cursorPointer" onclick="return addComment.moveForm('comment-186083', '186083', 'respond', '447104')">回复</span></span>--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                                {{--<div class="comment-content" itemprop="description">--}}
                                                    {{--<p>可以提前2个周和助教沟通 <img src="http://www.woshipm.com/wp-content/themes/pm/build/img/s/icon_wink.gif" alt=";-)" class="wp-smiley" style="height: 1em; max-height: 1em;"></p>--}}
                                                {{--</div>--}}
                                            {{--</div>--}}
                                        {{--</li><!-- #comment-## -->--}}
                                    {{--</ol><!-- .children -->--}}
