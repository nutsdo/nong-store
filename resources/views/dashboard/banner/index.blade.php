    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="vertical-top">
                ...
                <a href="{{ route('dashboard.banner.create') }}" class="btn btn-success btn-icon">
            ...
            <table class="table table-bordered table-striped" id="example-2">
                ...
                @foreach($banners as $banner)
                    <tr>
                        ...
                        <td>{{ $banner->id }}</td>
                        <td>{{ $banner->title }}</td>
                        <td>{!! Html::image($banner->image_url,null,['width'=>'80']) !!}</td>
                        <td>{{ $banner->image_url }}</td>
                        <td>{{ $banner->route_url }}</td>
                        <td>@if($banner->is_banned) 禁用 @else 正常 @endif</td>
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-primary" role="menu">
                                    <li>
                                        <a href="{{ route('dashboard.banner.edit',$banner->id) }}">修改</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" data-action="{{ route('dashboard.banner.destroy',$banner->id) }}" class="delete">删除</a>
                                    </li>
