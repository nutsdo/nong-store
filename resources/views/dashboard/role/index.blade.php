    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="vertical-top">
                ...
                <a href="{{ route('dashboard.role.create') }}" class="btn btn-success btn-icon">
            ...
            <table class="table table-bordered table-striped" id="example-2">
                ...
                @foreach($roles as $role)
                    <tr>
                        ...
                        <td>@if($role->is_banned) 禁用 @else 正常 @endif</td>
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-primary" role="menu">
                                    <li>
                                        <a href="{{ route('dashboard.role.edit',$role->id) }}">修改</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('dashboard.role.permission',$role->id) }}">权限设置</a>
                                    </li>
                                    <li>
                                        @if($role->is_banned) <a href="#">正常</a> @else <a href="#">禁用</a> @endif

                                    </li>
                                    <li>
                                        <a href="javascript:;" data-action="{{ route('dashboard.admin.destroy',$role->id) }}" class="delete">删除</a>
                                    </li>
