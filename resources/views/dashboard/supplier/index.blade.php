...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <div class="vertical-top">
            ...
            <a href="{{ route('dashboard.supplier.create') }}" class="btn btn-success btn-icon">
            ...
            @unless($suppliers->isEmpty())
                @foreach($suppliers as $supplier)
                    <tr>
                        ...
                        <td>@if($supplier->is_banned) 禁用 @else 正常 @endif</td>
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-primary" role="menu">
                                    <li>
                                        <a href="{{ route('dashboard.supplier.edit',$supplier->id) }}">修改</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" data-action="{{ route('dashboard.supplier.destroy',$supplier->id) }}" class="delete">删除</a>
                                    </li>
